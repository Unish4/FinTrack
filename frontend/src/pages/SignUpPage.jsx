      ...
      <div className="relative min-h-screen overflow-hidden bg-[#050505] text-white">
        ...
        <main className="relative z-10 mx-auto flex min-h-[calc(100vh-64px)] max-w-7xl flex-col-reverse items-center justify-center gap-10 px-4 py-8 sm:px-6 lg:flex-row lg:gap-14">
          ...
          <div className="w-full max-w-xl order-last lg:order-first">
            <h1 className="mb-6 text-4xl text-center font-serif leading-tight tracking-tight text-white sm:mb-8 sm:text-5xl">
              Control your money
              <br />
              with clarity.
            </h1>

            <p className="mt-4 max-w-lg text-base text-center leading-7 text-zinc-400 sm:mt-5">
              Track expenses, monitor income, upload receipts, and understand
              spending patterns through modern analytics and a clean interface.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2 sm:mt-10">
              <div className="group rounded-3xl border border-white/10 bg-white/4 p-5 backdrop-blur-xl transition-all duration-300 hover:border-violet-500/30 hover:bg-white/6 text-center">
              ...
              <div className="group rounded-3xl border border-white/10 bg-white/4 p-5 backdrop-blur-xl transition-all duration-300 hover:border-indigo-500/30 hover:bg-white/6 text-center">
              ...
              <div className="group rounded-3xl border border-white/10 bg-white/4 p-5 backdrop-blur-xl sm:col-span-2 transition-all duration-300 hover:border-emerald-500/30 hover:bg-white/6 text-center">
              ...
              <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-[#0d0d10]/95 p-2 shadow-2xl backdrop-blur-2xl transition-all duration-300 hover:border-violet-500/20 sm:p-3">
                <div className="overflow-hidden rounded-[28px] border border-white/10 bg-[#111113] p-4 sm:p-6 lg:p-8">
                  <div className="mb-4 sm:mb-6">
                    <h2 className="text-2xl font-bold tracking-tight text-center text-white sm:text-3xl">
                      Create your account
                    </h2>
                  ...
                  <SignUp
                    ...
                    appearance={{
                      ...
                      elements: {
                        ...
                        footerAction: "!mx-0 !justify-start !text-left",
